   ...
   public class MapManipulator
   {
      ...
      public void dissolveSteps()
      {
         ...
         finally
         {
            ...
            System.Runtime.InteropServices.Marshal.ReleaseComObject(layer_1);
      ...
      private IFeatureClass buildNewFeatureClass(IFeatureClass inFeatureClass, ref int socialIndex)
      {
         ...
         return myFeatWrkSpace.CreateFeatureClass("NewSocialCliped" + socialIndex.ToString(), inFeatureClass.Fields, inFeatureClass.CLSID, inFeatureClass.EXTCLSID, inFeatureClass.FeatureType, inFeatureClass.ShapeFieldName, "");
      ...
      private void editUnionFeatureClass()
      {
         ...
         try
         {
            ...
            //qf.WhereClause = "CurrTime_1 = 1 AND Availabl_1 = 1";
            //t = this.getTable(this.occupiedFeatureClass);
            //indexAvailable = t.FindField("Available");
            //indexAvailable_1 = t.FindField("Availabl_1");
            //buffy = t.CreateRowBuffer();
            //buffy.set_Value(indexAvailable, 1);
            //t.UpdateSearchedRows(qf, buffy);
            //qf.WhereClause = "CurrTime_1 = 1 AND Availabl_1 = 0";
            //buffy.set_Value(indexAvailable, 0);
            //t.UpdateSearchedRows(qf, buffy);
      ...
      private ITable getTable(IFeatureClass inFeature)
      {
         IFeatureLayer featureLayer_2 = new FeatureLayerClass();
         ILayer layer = null;
         try
