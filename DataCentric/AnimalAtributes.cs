...
namespace SEARCH
{
   ...
   public class AnimalAtributes
   {
      ...
      private double mInitialEnergy;
      //initial energy level for start of program
      private double mMaxEnergy;
      //most energy this species can store
      private double mMinEnergy_Survive;
      //less amount before starvation
      private Duration[] myActivityDuration;
      //an array of times for george to be awake or asleep
      private double mWakeUpTime;
      //start of the day for george
      private double mPerceptionDistance;
      //how far can george see around him(base line)
      private double mForageSearchTrigger;
      //level of energy that will force george to switch from 
      //searching for a home to foraging for food and back
      private double mRiskySafeTrigger;
      //percentage to make george feel safe (Roll of Dice – Observed Risk) < mRiskySafeTrigger
      private double mSafeRiskyTrigger;
      //percentage to make george feel scared (Roll of Dice – Observed Risk) > mSafeRiskyTrigger
      private double mSafeProbCaptureFoodMod;
      //modifier used to adjust george's probability of capturing food wwhen he feels safe
      private double mSafeProbGetKilledMod;
      //modifier used to adjust george's probability of getting killed when he feels safe
      private double mRiskyProbCaptureFoodMod;
      //modifier used to adjust george's probability of capturing food when he feels threatened
      private double mRiskyProbGetKilledMod;
      //modifier used to adjust george's probability of getting killed when he feels threatened
